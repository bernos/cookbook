...
exports.basicTextField = function(item, field) {
  ...
  buf.push('<input type="text" name="' + field.name + '" id="' + field.name + '-editor" value="' + field.value(item) + '"></input>');
  buf.push('</div>');
...
exports.dateField = function(item, field) {
  var buf = ['<div>'];
  buf.push('<label for="' + field.name + '-editor">' + field.label(item)  + '</label>');
  buf.push('<input type="text" name="' + field.name + '" id="' + field.name + '-editor" value="' + field.formatter(item) + '"></input>');
  buf.push('</div>');
